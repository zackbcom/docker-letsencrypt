...
If you are having issues with certbot not supporting challenges that will satisfy the CA, please set HTTPVAL to true, expose port 80, and enable the server block for port 80 in your nginx cofnig. This will use the authentication method HTTP-01. See below in _Optional settings_ on how to set these. [source](https://community.letsencrypt.org/t/important-what-you-need-to-know-about-tls-sni-validation-issues/50811)
